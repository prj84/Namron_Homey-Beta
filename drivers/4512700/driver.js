...
class MyDriver extends SrZigBeeDriver {
  ...
  onInit () {
    ...
    this._levelStepActionCard = this.getActionCard('4512700_level_step_with_onoff')
    ...
    this._levelMoveActionCard = this.getActionCard('4512700_level_move_with_onoff')
    ...
    this._levelStopActionCard = this.getActionCard('4512700_level_stop_with_onoff')
    ...
    this._recallSceneActionCard = this.getActionCard('4512700_recall_scene')
    ...
    this._storeSceneActionCard = this.getActionCard('4512700_store_scene')
