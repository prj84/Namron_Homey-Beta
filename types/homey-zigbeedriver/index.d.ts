...
declare module 'homey-zigbeedriver' {
  ...
  interface ClusterCapabilityConfiguration {
    ...
    setParser?: (setValue: any) => Promise<object|null>;
    report?: string;
    reportOpts?: {
      configureAttributeReporting?: AttributeReportingConfiguration;
    };
    reportParser?: (reportValue: any) => null | Promise<any>;
    endpoint?: number;
    getOpts?: {
      getOnStart: boolean;
      getOnOnline: boolean;
  ...
  interface ZigbeeDeviceInitPayload { zclNode: ZCLNode, node: ZigBeeNode }

  class ZigBeeDevice extends Homey.Device {
    onNodeInit(payload: ZigbeeDeviceInitPayload): void;
    onMeshInit(): void;
  ...
  class ZigBeeLightDevice extends ZigBeeDevice {
    ...
    get levelControlCluster(): any;
    get onOffCluster(): any;
    get colorControlCluster(): any;
