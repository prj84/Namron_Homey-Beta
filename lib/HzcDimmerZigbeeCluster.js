...
const ATTRIBUTES = {
    ...
    setInitialBrightness: {id: 0x4000, type: ZCLDataTypes.uint8},

    // D089-GB, D726-ZG
    minBrightness: {id: 0x0002, type: ZCLDataTypes.uint8},
    maxBrightness: {id: 0x0003, type: ZCLDataTypes.uint8},
    // D089-GB
    // 开灯的起始亮度
    onLevel2: {id: 0x11, type: ZCLDataTypes.uint8},
};
